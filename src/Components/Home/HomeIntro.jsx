    ...
    <div className="w-full flex flex-col items-center py-16">
      ...
      <div className="p-5 px-10 rounded-lg bg-white flex flex-row gap-20 mt-10">
        <div className="flex flex-col items-center">
          ...
          <p className="font-semibold text-xl mt-3 mb-1.5">Education</p>
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="font-semibold text-xl mt-3 mb-1.5">Projects</p>
          <p className="text-center text-sm">
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="font-semibold text-xl mt-3 mb-1.5">Years Study</p>
          <p className="text-center text-sm">
            One year study of <br></br> web development
          </p>
        </div> 
      </div>
    </div>
